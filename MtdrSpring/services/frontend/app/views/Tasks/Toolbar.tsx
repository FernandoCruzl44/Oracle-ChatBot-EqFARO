...
export function Toolbar({
  ...
  return (
    <div className="py-4">
      <div className="flex min-w-max items-center justify-between gap-x-2">
        {/* Left Section */}
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <button
                ...
                className="flex flex-shrink-0 flex-row items-center rounded-lg border border-red-400 p-2 text-sm text-red-400 transition-colors hover:bg-red-900/50 2xl:px-3 2xl:py-2.5"
                title={`Eliminar (${selectedTasks.length})`}
                aria-label={`Eliminar (${selectedTasks.length})`}
              >
                <i className="fa fa-trash 3xl:mr-2"></i>
              ...
              <button
                ...
                className="flex flex-shrink-0 items-center rounded-lg border border-amber-400 p-2 text-sm text-amber-400 transition-colors hover:bg-amber-900/50 2xl:px-3 2xl:py-2.5"
                title="Deseleccionar todo"
                aria-label="Deseleccionar todo"
              >
                <i className="fa fa-times-circle 3xl:mr-2"></i>
                <span className="3xl:inline hidden">Ninguno</span>
              </button>
            </div>
          </div>
        </div>
